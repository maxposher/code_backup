     ...
     -- Discount Buyer is not D2 timestamp
    ...
    /* Actor_One - Actor Model for data collection - Project Newton II */
     ...
     --Actor Two
     SELECT U.user_id, 
     avg(CASE WHEN (R."v" = 'l')                     THEN 1 ELSE 0 END) AS liker,
     avg(CASE WHEN (R."v" = 'p' AND R."do|t" = 'c')  THEN 1 ELSE 0 END) AS commentor,
     avg(CASE WHEN (R."v" = 'p' AND R."do|t" = 'l')  THEN 1 ELSE 0 END) AS listor,
     avg(CASE WHEN (R."v" = 'f' AND R."do|t" = 'b')  THEN 1 ELSE 0 END) AS follower_B,
     avg(CASE WHEN (R."v" = 'f' AND R."do|t" = 'u')  THEN 1 ELSE 0 END) AS follower_P,
     avg(CASE WHEN (R."v" = 's' AND R."do|t" = 'l')  THEN 1 ELSE 0 END) AS  i_share,
     avg(CASE WHEN (R."v" = 'es' AND R."do|t" = 'l') THEN 1 ELSE 0 END) AS  e_share,
     avg(CASE WHEN (R."v" = 'sch' AND R."do|f" = 'l') THEN 1 ELSE 0 END) AS searcher
     FROM analytics.dw_users AS U
     INNER JOIN raw_hive.october_events as R ON R."a|id" = U.user_id
     WHERE date(U.join_date) BETWEEN '2015-10-07' AND '2015-11-07'
     ...
     WHERE R."at" < dateadd(hour,48, U.joined_at)    /* U is actor  */   
     ...
     /* Actor Four - Done Followers */
      ...
      WHERE (R."at") < dateadd(hour,48, U.joined_at)  
      AND   date(U.join_date) BETWEEN '2015-10-07' AND '2015-11-07'   
      AND   R."v" = 'f' 
      AND   R."do|t" = 'u'
      GROUP BY 1
      ...
      INNER JOIN ( SELECT R."a|id" AS buyer_id, L.seller_id AS actor_id
                   ...
                   WHERE date(U.join_date) BETWEEN '2015-10-07' AND '2015-11-07'
                   AND  (R."at") < dateadd(hour,48, U.joined_at)   /* U is actor */ 
 ...
 /*  Backup Code */   
    ...
    select L."at", dateadd(day, 1 , L."at") 
    from  raw_hive.october_events as L
    limit 10
    
    SELECT R."v", max(R."at"), R."a|id"
    FROM
    raw_hive.october_events AS R
    GROUP BY 1, 3
    limit 10
